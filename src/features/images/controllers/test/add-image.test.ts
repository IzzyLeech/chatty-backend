...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    ...
    it('should call updateSingleUserItemInCache method', async () => {
      ...
      const url = `https://res.cloudinary.com/${process.env.CLOUD_NAME}/image/upload/v1234/123456`;
    ...
    it('should call addImageJob method', async () => {
      ...
      expect(imageQueue.addImageJob).toHaveBeenCalledWith('addUserProfileImageToDB', {
        ...
        value: `https://res.cloudinary.com/${process.env.CLOUD_NAME}/image/upload/v1234/123456`,
        imgId: '123456',
        imgVersion: '1234'
      });
      expect(res.status).toHaveBeenCalledWith(200);
  ...
  describe('backgroundImage', () => {
    ...
    it('should call addImageJob method', async () => {
      ...
      await Add.prototype.backgroundImage(req, res);
      expect(imageQueue.addImageJob).toHaveBeenCalledWith('updateBGImageToDB', {
        key: `${req.currentUser?.userId}`,
        imgId: '123456',
        imgVersion: '1234'
      });
